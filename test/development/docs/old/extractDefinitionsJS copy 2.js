...
*/
    ...
    const TurboDocJs= class{ 
      static String=class{
       ...
       collect ={
        vlcDefinitionAssigned:(lines,line,attributes,options,level)=>{
          ...
          if(assignee.startsWith('"')||assignee.startsWith("'")){ 
            collected = this.collect.assigneeQuotedString(assignee,lines,line,attributes,options,level);  
          ...
          if(assignee.startsWith('`')){
            collected = this.collect.asigneeEnclosure('`','`',[],lines,line,attributes,options,level);  
            attributes.offset = collected[options.nodeDataKeyName]['end'] +2; //2 = 1 the new line, 1 for the next char 
          }
          else
          //## object assignee 
          ...
          if(this.REGEX.NUMBER.test(assignee)){
            collected = this.collect.assigneeNumber(assignee,line,attributes,options,level); 
            attributes.offset = collected[options.nodeDataKeyName]['end'] +2; //2 = 1 the new line, 1 for the next char 
          }
          else 
          //## anonymous function assignee       
            if(this.REGEX.ANONYMOUS_FUNCTION.test(assignee)){      
            collected = this.collect.assigneeAnonymousFunction(lines,line,attributes,options,level); 
            attributes.offset =  collected[options.nodeDataKeyName]['end'] +2; //2 = 1 the new line, 1 for the next char  
          }
          else
          //## anonymous class assignee       
            if(this.REGEX.ANONYMOUS_CLASS.test(assignee)){      
            collected = this.collect.assigneeAnonymousClass(lines,line,attributes,options,level); 
            attributes.offset =  collected[options.nodeDataKeyName]['end'] +2; //2 = 1 the new line, 1 for the next char  
          }
          //  else
        ...
        // Unassigned variable
        vlcDefinition:(lines,line,attributes,options,level)=>{
          ...
          var collected = null; 
        //  console.log(attributes.offset,line)
            collected={
        ...
        prototypeDefinition:(lines,line,attributes,options,level)=>{ 
          var collected = null
          ...
          if(closure){
            collected={ 
              ...
              ...this.extract(lines.text,options,{offset:closure.start+1,limit:closure.end-1},level+1)
        ...
        classDefinition:(lines,line,attributes,options,level)=>{
          var collected = null
          //# class definiton       
        ...
        functionDefinition:(lines,line,attributes,options,level)=>{
          var collected = null
        ...
        assigneeAnonymousClass:(lines,line,attributes,options,level)=>{
          var {offset} = attributes;
          var collected = null;
        ...
        assigneeAnonymousFunction:(lines,line,attributes,options,level)=>{
          var {offset} = attributes;
          var collected = null;
          var argsClosure = extractClosure(lines.text,{opener:'(',closer:')',offset: offset});
          ...
          var closure = extractClosure(lines.text,{offset:argsClosure.end+1});
            ...
            collected={
              ...
              ...(closure.matchInner.trim().length<0) && this.extract(lines.text,options,{offset:closure.start+1,limit:closure.end-1},level+1)
        ...
        asigneeEnclosure:(opener,closer,excludes,lines,line,attributes,options,level)=>{
          var {offset} = attributes;
        ...
        assigneeQuotedString:(input,lines,line,attributes,options,level)=>{
          var {offset} = attributes;
        ...
        assigneeNumber:(input,line,attributes,options,level)=>{
          var {offset} = attributes;
          //## number assignee
          var collected = null;
          if(/^-?\d+(\.\d+)?/g.test(input)){
      ...
      extract(input,options={},attributes={},level=0){
        ...
        while(attributes.offset<input.length){
          ...
          if(!collected) collected = this.collect.vlcDefinitionAssigned(lines,line,attributes,options,level);
        
          if(!collected) collected = this.collect.vlcDefinition(lines,line,attributes,options,level);
          if(!collected) collected = this.collect.functionDefinition(lines,line,attributes,options,level);
          if(!collected) collected = this.collect.classDefinition(lines,line,attributes,options,level);
          if(!collected) collected = this.collect.prototypeDefinition(lines,line,attributes,options,level);
